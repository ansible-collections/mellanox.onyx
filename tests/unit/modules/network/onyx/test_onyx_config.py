...
from ansible_collections.mellanox.onyx.plugins.modules.network.onyx import onyx_config
...
class TestOnyxConfigModule(TestOnyxModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.mellanox.onyx.plugins.modules.network.onyx.onyx_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.mellanox.onyx.plugins.modules.network.onyx.onyx_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.mellanox.onyx.plugins.modules.network.onyx.onyx_config.run_commands')
